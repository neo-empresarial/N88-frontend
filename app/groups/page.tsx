  ...
  const acceptFriendRequest = async (friendshipId: number) => {
    try {
      ...
      if (response.ok) {
        ...
        refetchFriends(); // Atualizar lista de amigos
        refetchPending(); // Atualizar solicitações pendentes
      } else {
  ...
  return (
    <div className="flex flex-col items-center justify-center w-full h-full">
      ...
      <div className="grid grid-cols-3 gap-4 w-4/5 h-2/3">
        ...
        {/* ✅ Nova div para gerenciar amizades */}
        <div className="flex flex-col h-full bg-gray-100 dark:bg-gray-800 rounded-lg p-6">
          <div className="flex flex-row justify-center items-center gap-2 mb-4">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex gap-1">
                        ...
                        <Button
                          ...
                          variant="outline"
                          onClick={() => {
                            // TODO: Implementar adicionar ao grupo
